...
export class KeywordExtractor {
    ...
    generateIndustryKeywords(industry, role) {
        const keywordMap = {
            'technology': {
    ...
    extractTechnicalKeywords(words) {
