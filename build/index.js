                    ...
                    case "suggest_profile_enhancements":
                        return {
                            content: [
                                {
                                    type: "text",
                                    text: this.enhancementSuggester.suggest(args.profile_text, args.target_role, args.experience_level),
                                },
                            ],
                        };
                    case "compare_profile_resume":
                        return {
                            content: [
                                {
                                    type: "text",
                                    text: this.resumeComparer.compare(args.profile_text, args.resume_text),
                                },
                            ],
                        };
                    case "generate_keyword_optimization":
                        return {
                            content: [
                                {
                                    type: "text",
                                    text: this.enhancementSuggester.generateKeywords(args.profile_text, args.industry, args.target_role),
                                },
                            ],
                        };
                    default:
